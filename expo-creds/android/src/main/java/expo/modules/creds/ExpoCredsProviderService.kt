 ...
 *   - https://github.com/android/snippets/blob/main/identity/credentialmanager/src/main/java/com/example/identity/credentialmanager/MyCredentialProviderService.kt
 */
