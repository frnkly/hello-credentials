/**
 * Mostly copied from the Android documentation for testing purposes.
 *
 *   - https://developer.android.com/identity/sign-in/credential-provider
 *   - https://github.com/android/snippets/blob/main/identity/credentialmanager/src/main/java/com/example/identity/credentialmanager/CredentialProviderDummyActivity.kt
 */
package expo.modules.creds
